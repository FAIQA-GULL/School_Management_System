...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="principal_main_page.php">Home</a></li>
      
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Teacher <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="principale_teachers_info.php">Teacher Info</a></li>
          <li><a href="principale_teacher_attendance.php">Attendance and Updates</a></li>
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Student <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="principale_students_info.php">Student Info</a></li>
          <li><a href="principale_student_attendance.php">Attendance</a></li>
          <li><a href="principale_student_result.php">Results</a></li>
        </ul>
      </li>
      <li><a href="principale_courses.php">Assign Courses</a></li>
       <li><a href="principale_subject.php">Subjects</a></li>
