...
<div class="container-fluid">
	<div class="row">
	<form method="POST" action="district_student_result_report.php">
		<center>
			<h3>Search</h3>
			<h3>Student Result Report BY school and Class</h3>
		...
		<div class="form-group has-success" style="margin-top: 50px; ">
			...
			<br>
			<button type="submit" name= "search"  class="btn btn-dark">Search Student Result</button>
