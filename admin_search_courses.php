...
<div class="container-fluid">
	<div class="row">
	<form method="POST" action="admin_assign_courses.php">
		<center>
			<h3>Search Assign Courses to Teachers BY Selecting School and Section</h3>
		...
		<div class="form-group has-success" style="margin-top: 50px; ">
			...
			<br>
			<button type="submit" name= "search"  class="btn btn-dark">Search Assigned Courses </button>
