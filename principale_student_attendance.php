...
<div class="container">
  <center><h2 style="color: black;">Student Attendance</h2>
    <div class="row">
      <!-- <div class="col-sm-4">
      ...
      <div class="col-sm-11">
        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            $sql="SELECT student_attendance.sta_attendance , student.std_name,student.std_id, student_attendance.class_id , class.class_name FROM `student_attendance` JOIN student on student_attendance.student_id = student.std_id JOIN class on class.class_id = student_attendance.class_id WHERE student_attendance.class_id <=5";
            ...
            <tbody>
              <tr>
                ...
                <td><a href="principale_student_update.php?std_id=<?php echo $row['std_id'];?>&sta_attendance=<?php echo $row['sta_attendance'];?>&class_name=<?php echo $row['class_name'];?>" class="btn btn-success">Edit</a>
    ...
    <div class="row">
      ...
      <div class="col-sm-11">
        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            $sql=" SELECT student_attendance.sta_attendance , student.std_name,student.std_id, student_attendance.class_id , class.class_name FROM `student_attendance` JOIN student on student_attendance.student_id = student.std_id JOIN class on class.class_id = student_attendance.class_id WHERE student_attendance.class_id BETWEEN 6 AND 7";
    ...
    <div class="row">
      ...
      <div class="col-sm-11">
        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            <?php 
            // $id=$_SESSION['user']['user_id'];
            $sql="SELECT student_attendance.sta_attendance , student.std_name,student.std_id, student_attendance.class_id , class.class_name FROM `student_attendance` JOIN student on student_attendance.student_id = student.std_id JOIN class on class.class_id = student_attendance.class_id WHERE student_attendance.class_id =8";
            $info = mysqli_query($conn, $sql); 
            if (mysqli_num_rows($info) > 0)
              {
                $sno = 1;
