...
<div class="container">
    ...
    <div class="col">
		...
		<a href="#add" data-toggle="modal" class="pull-right btn btn-warning"><span class="glyphicon glyphicon-plus"></span> Add New Student</a>
		<br>
		<br>
		<br>
	    ...
	    <table class="table table-hover table-striped table-bordered">
		    ...
		    where student.section_id=section.section_id
		    ";
		    ...
		    <tbody>
		    	<tr>
				    ...
				    <td>
								<a href="#editproduct<?php echo $row['std_id']; ?>" data-toggle="modal" class="btn btn-success"><span class="glyphicon glyphicon-pencil"></span> Edit</a> 
								||
								...
								<?php include('principale_student_update_modal.php'); ?>
				    </td>
		    	</tr>
		    </tbody>
		    <?php
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <form method="POST" action="principale_add_new_student.php" >
