...
?>
				...
				<tr>
					...
					<td><?php echo $row['section_name'];?></td>
					<td><a href="open_student_result_report.php?std_id=<?php echo $row['std_id'];?>&std_name=<?php echo $row['std_name'];?>&class_id=<?php echo $row['class_id'];?>&section=<?php echo $row['section_id'];?>&section_name=<?php echo $row['section_name'];?>" class="btn btn-success">Report</a></td>
					<!-- <td></td> -->
