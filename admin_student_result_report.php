...
$sql="SELECT * FROM  
      section JOIN student
      ON section.section_id=student.section_id
      JOIN student_result 
      ON student_result.std_id = student.std_id 
      WHERE student_result.class_id = '$class'
      AND  student_result.section_id='$section_id' AND section.sch_id='$school_id'";
      print_r($sql);
...
?>
			...
			<tbody>
				<tr>
					...
					<td><a href="admin_open_student_result_report.php?std_id=<?php echo $row['std_id'];?>&std_name=<?php echo $row['std_name'];?>&class_id=<?php echo $row['class_id'];?>&section_id=<?php echo $row['section_id'];?>&section_name=<?php echo $row['section_name'];?>" class="btn btn-success">Report</a></td>
					<!-- <td></td> -->
