...
<div class="container">
  ...
  <div class="row">
    <div class="col">
        ...
        join student_result 
        on student_result.std_id = student.std_id WHERE student.section_id =".$_SESSION['user']['section_id']."  $where";
        print_r($sql);
...
<script type="text/javascript">
  $(document).ready(function(){
    $("#catList").on('change', function(){
      if($(this).val() == 0)
      {
        window.location = 'primary_student_result.php';
      }
      else
      {
        window.location = 'primary_student_result.php?category='+$(this).val();
      }
    });
  });
