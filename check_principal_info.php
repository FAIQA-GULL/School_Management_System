...
<div class="container">
	<div class="row">
		<div class="col">
		<center><h1>Principal Information </h1></center>
	    ...
	    <table class="table table-hover table-striped table-bordered">
			...
			<tr>
		      ...
		      <?php 
		        ...
		        $sql="SELECT user_info.user_name ,user_info.user_id
		        ,user_info.NIC, attendance.attendance
		        
		        from user_info left join attendance 
		        on user_info.user_id=attendance.user_id 
		         WHERE  user_info.user_type ='Principal'
		    ...
		    <tbody>
		    	<tr>
				    ...
				    <td>
							...
							<?php include('principale_update_modal.php'); ?>
				    </td>
...
<br><br><br>
		...
		<table class="table table-hover table-striped table-bordered">
			<thead>
				<tr>
					<th>Sr.no</th>
					<th style="background-color: #7FB3D5 ; color: white;" >Employee ID </th>
					<th>Name</th>
					<th>Leave Status</th>
					<th>Leave Detail</th>
					<th>Date - Time</th>
		    ...
		    <tbody>
		    	<tr>
		    		<?php echo "<th>".($sno++)."</th>"; ?>
		    		<td style="background-color: #7FB3D5 ; color: white;" >
