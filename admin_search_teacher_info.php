...
<div class="container-fluid">
	<div class="row">
	<form method="POST" action="admin_teachers_info.php">
		<center>
			<h3>Search Teacher info BY Selecting School</h3>
		...
		<div class="form-group has-success" style="margin-top: 50px; ">
			...
			<br>
			<button type="submit" name= "search"  class="btn btn-dark">Search Teacher Info</button>
