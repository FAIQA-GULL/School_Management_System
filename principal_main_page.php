...
<div class="container">
	<center><h3 style="color: black">Welcome School Principale</h3></center>
	<br>
		<div class="row">
			<div class="col-sm-4">
				<h2>About Me</h2>
					...
					<table class="table table-hover table-striped table-bordered">
						...
						<tbody>
							<tr>
								...
								<a name="id" href="principal_main_page.php?action=Enable&user_id=<?php echo $_SESSION['user']['user_id']; ?>"  class="btn btn-success"><span class="glyphicon glyphicon-ok"></span> Present</a>
								

								|| 

								<a href="principal_main_page.php?action=disable&user_id=<?php echo $_SESSION['user']['user_id'];?>"  class="btn btn-danger" ><span class="glyphicon glyphicon-remove"></span> Absent </a>
...
if(isset($_GET["action"]))
  {
	...
	// UPDATE `attendance` SET `att_id`=[value-1],`attendance`=[value-2],`user_id`=[value-3],`date_time`=[value-4] WHERE 1
           ...
           echo '<script>alert("Attendance Marked!")</script>';
            echo '<script>window.location="principal_main_page.php"</script>';
