  ...
  <center><h2 style="color: black;">Teacher Attandence and Updates</h2></center>
    ...
    <div class="col">
      <center><h3>Primary Section Teacher Attendance</h3></center>
        ...
        WHERE user_info.user_type='teacher' AND user_info.section_id=1 AND attendance.date_time=CURRENT_DATE() AND user_info.sch_id='$school_id'";
        // print_r($sql);
         // student.section_id=section.section_id;
            ...
            <td><?php echo $row["date_time"];?></td>
				    ...
				    <td>
								<a href="admin_teacher_update.php?user_id=<?php echo $row['user_id'];?>&user_name=<?php echo $row["user_name"]; ?>&NIC=<?php echo $row["NIC"];?>&attendance=<?php echo $row["attendance"];?>&date=<?php echo $row["date_time"];?>" class="btn btn-success"><span class="glyphicon glyphicon-pencil"></span>Update </a> 
						</td>
  ...
  <div class="row">
    <div class="col">
      ...
      <tr>
        ...
        $sql="SELECT * from attendance join user_info 
        on attendance.user_id=user_info.user_id 
        WHERE user_info.user_type='teacher' AND user_info.section_id=2 AND attendance.date_time=CURRENT_DATE() AND user_info.sch_id='$school_id'";
        // print_r($sql);
         // student.section_id=section.section_id;
  ...
  <div class="row">
    <div class="col">
      ...
      <tr>
        ...
        $sql="SELECT * from attendance join user_info 
        on attendance.user_id=user_info.user_id 
        WHERE user_info.user_type='teacher' AND user_info.section_id=3 AND attendance.date_time=CURRENT_DATE() AND user_info.sch_id='$school_id'";
        // print_r($sql);
         // student.section_id=section.section_id;
