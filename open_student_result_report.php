 ...
 $obtained_marks = 0;
		...
		?>
				...
				<tr>
					...
					<td> <input type="text" name="o_marks"  class="form-control sit" value="<?php echo $row['obtained_marks'];?>"> / <input type="text"  class="form-control sit" name="t_marks" value="<?php echo $row['total_marks'];?>"></td>
